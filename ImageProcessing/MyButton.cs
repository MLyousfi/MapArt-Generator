...
namespace ImageProcessing
{
    ...
    public enum Corners
    {
        ...
        BothTop = TopLeft | TopRight,
        BothBottom = BottomLeft | BottomRight
    }
    ...
    public class MyButton : Control, IButtonControl
    {
        ...
        public float[] factor = new float[] {0,0,1,1};
    ...
    [Category("Appearance"), DefaultValue(typeof(ContentAlignment), "MiddleCenter")]
        ...
        protected override void OnPaintBackground(PaintEventArgs pevent)
        {
            ...
            b.Factors = factor;//new float[] { 1, 1, 0, 0 };
            paintBrush.Blend = b;
